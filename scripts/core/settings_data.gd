...
##
## ⚠️ Une clé `pixelation` héritée d'avant `ADR-0045` est simplement IGNORÉE : le
## post-process rétro n'existe plus, et un `settings.cfg` écrit par une version
## précédente doit continuer de se relire sans une erreur.
