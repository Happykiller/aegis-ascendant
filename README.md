...
- [x] Phase 0 — Bootstrap (dépôt, projet Godot, scripts, tests, export Windows) — *validée sur Windows/RTX 4080*
- [ ] Phase 1 — Graybox jouable *(en cours — déjà là : chasseur pilotable, tir Pulse via
  BulletManager 600 projectiles, Needle Scouts, vague data-driven de 10 ennemis, score ;
  baseline perf : `docs/balance/graybox_baseline.md`)*
